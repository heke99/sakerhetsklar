 ...
 * Sensitive operations require an authenticated session; the frontend never
...
const doc = {
  ...
  paths: {
    ...
    "/tenants/{id}/invitations": {
      ...
      post: { summary: "Invite user with role", responses: { "201": { description: "Invitation + one-time token" } } },
    },
    "/tenants/{id}/members": {
